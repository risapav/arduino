...
const char *password = "logika";  // The password required to connect to it, leave blank for an open network
...
void startWiFi() { // Start a Wi-Fi access point, and try to connect to some given access points. Then wait for either an AP or STA connection
  ...
  wifiMulti.addAP("PRwifi3", "CicaMica2");   // add Wi-Fi networks you want to connect to
